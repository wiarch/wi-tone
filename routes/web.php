...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('songs', SongController::class)->only(['create', 'store', 'show', 'edit', 'update']);

    Route::resource('service-plans', ServicePlanController::class)->only(['create', 'store', 'show']);
